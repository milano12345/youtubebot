...
def login_with_username_and_password(browser, username, password):
    ...
    next_button = browser.find_element(By.CSS_SELECTOR, "button")
    time.sleep(2)
    next_button[2].click()
    time.sleep(2)
    ...
    confirm_button = browser.find_element(By.CSS_SELECTOR, "div[role=button]")
    time.sleep(2)
...
def click_on_agree_and_signin(browser):
    ...
    signin_buttons= browser.find_element(By.CSS_SELECTOR, ".signin")
...
def enter_comment(browser, comment):
    comment_input = browser.find_element(By.CSS_SELECTOR, "ytd-comment-simplebox-renderer")
    ...
    send_comment_button = browser.find_element(By.ID, "submit-button")
